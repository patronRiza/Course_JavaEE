...
@Configuration
@Profile({"debug", "sandbox"})
public class LocalJDBCTemplateConfig implements IJDBCTemplateConfig {
    ...
    public LocalJDBCTemplateConfig(@Value("${spring.datasource.url}") final String url,
